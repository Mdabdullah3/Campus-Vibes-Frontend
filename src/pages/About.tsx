...
const About = () => {
    ...
    return (
        <div className='w-11/12 mt-10 mx-auto bg-[#faf9f4bf]'>
            <div className='flex pt-10 justify-center'>
                <Image src={topImg} alt="" />
            </div>
            <div>
                <h1 className='text-6xl mt-6 text-secondary text-center font-medium tracking-wider'>About Campus Vibes</h1>
                <p className='text-md text-[#7E7E7E] mt-4 tracking-wider w-7/12 mx-auto text-center'>Welcome to Campus Vibes, the heartbeat of our university community! We are more than just a website; we are your go-to platform for all things campus-related. Whether you're a new student looking to dive into the vibrant campus life or a seasoned academic explorer, Campus Vibes is your digital companion on this exciting journey.</p>
            </div>
